...
params:
  sim_name:
    ...
    value: "Local Feature Stability Sims"
  sim_path:
    label: "Path to Experiment Folder:"
    value: "/Users/Tiffany/My Documents/Research/Yu/Local Feature Stability/local-feature-stability/results/Local Feature Stability Sims"
  verbose:
    label: "Verbose Level:"
    value: 2
  # external_files:
...
#'   2 = print out directory name and name of evaluators/plots
    ...
    for (plot_name in names(plot_results)) {
      ...
      for (plt_name in names(plts)) {
        ...
        subchunkify(plt, i = chunk_idx,
                    ...
                    other_args = "out.width = '100%'", add_class = add_class)
        chunk_idx <<- chunk_idx + 1
      }
    }
  }
