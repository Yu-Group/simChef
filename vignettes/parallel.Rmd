...
system.time(
  o <- experiment$fit(
    n_reps = 2, parallel_strategy = c("reps")
  )
)

system.time(
  o <- experiment$fit(
    n_reps = 2, parallel_strategy = c("dgps")
  )
)

system.time(
  o <- experiment$fit(
    n_reps = 2, parallel_strategy = c("methods")
  )
)
...
system.time(
  o <- experiment$fit(
    n_reps = 2, parallel_strategy = c("reps", "methods")
  )
)

system.time(
  o <- experiment$fit(
    n_reps = 2, parallel_strategy = c("dgps", "methods"),
  )
)

system.time(
  o <- experiment$fit(
    n_reps = 2, parallel_strategy = c("reps", "dgps", "methods")
  )
)
```
