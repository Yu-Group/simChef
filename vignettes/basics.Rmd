...
power_plot <- function(results, eval_results = NULL) {
  require(ggplot2)
  plt <- ggplot(results) +
...
plotter <- create_plot(power_plot)
...
# easily get all descendants
descendants <- experiment$get_descendants(include_self=TRUE)
```
