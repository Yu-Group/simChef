...
![Overview of fitting a `simChef` `Experiment`. Inputs and outputs for user-defined functions are also provided.](figures/fit_experiment.png){width=100% #fig:fit-experiment-figure}
...
![Overview of evaluating a `simChef` `Experiment`. Inputs and outputs for user-defined functions are also provided. Dotted boxes denote optional input arguments.](figures/eval_experiment.png){width=100% #fig:eval-experiment-figure}
...
![Overview of visualizing a `simChef` `Experiment`. Inputs and outputs for user-defined functions are also provided. Dotted boxes denote optional input arguments.](figures/viz_experiment.png){width=100% #fig:viz-experiment-figure}
