...
To help with onboarding and setting up your simulation study, we have provided a helper function `init_sim_project()`.

```{r create-sim, eval = FALSE}
init_sim_project(path = "path/to/sim/dir")
```

`init_sim_project()` initializes a ready-to-use directory for your `simChef` simulation study.
